...
$recebe_anime_filmes = $_POST['anime_filmes'];
...
try {
	$alterar = $conexao->query("UPDATE animes SET
	nome = '$recebe_nome',
	nome_completo = '$recebe_nome_completo',
	anime_filmes = '$recebe_anime_filmes',
	...
	foto3 = '$img_nome4',
	foto4 = '$img_nome5',
	foto5 = '$img_nome6' WHERE id = '$id_prod'");
