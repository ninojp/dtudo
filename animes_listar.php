	...
	<?php while ($exibir = $consulta->fetch(PDO::FETCH_ASSOC)) { ?>
		<div id="div_animes">
			...
			<figure id="figure_foto">
				<img id="img_foto" src="imgs/animes/<?php echo $exibir['fotomini']; ?>" class="img-responsive">
			...
			<div class="div_class_btn">
				<a href="anime_alterar.php?id=<?php echo $exibir['id']; ?>">	
					<button class="meu_btn"> Alterar </button></a>
				<a href="excluir.php?id=<?php echo $exibir['id']; ?>">	
